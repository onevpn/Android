...
import co.onevpn.android.BuildConfig;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null && intent.hasExtra(VpnProfile.EXTRA_PROFILEUUID)) {
            String profileUUID = intent.getStringExtra(VpnProfile.EXTRA_PROFILEUUID);
            int profileVersion = intent.getIntExtra(getPackageName() + ".profileVersion", 0);
            Logger.d("OpenVPNService.onStartCommand: " + profileUUID);
    ...
    private void startOpenVPN() {
        ...
        AppPreferences prefs = OneVpnApp.getInstance().getPreferences();
    ...
    public void onCreate() {
        ...
        Logger.d("created OpenVPNService");
    }

    @Override
    public void onDestroy() {
        Logger.d("destroyed OpenVPNService");
        synchronized (mProcessLock) {
            if (mProcessThread != null) {
    ...
    private void addLocalNetworksToRoutes() {
        ...
        Logger.d("addLocalNetworksToRoutes");
