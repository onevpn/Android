...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public static final String EXTRA_PROFILEUUID = OneVpnApp.getInstance().getPackageName() + ".profileUUID";
...
//        }
    ...
    public Intent getStartServiceIntent(Context context) {
        ...
        Logger.d("VpnProfile.getStartServiceIntent: " + mUuid.toString());

        Intent intent = new Intent(context, OpenVPNService.class);
        intent.putExtra(VpnProfile.EXTRA_PROFILEUUID, mUuid.toString());
